---
title: "Introduction"
description: "Welcome to the absolute easiest way to build and hand off websites."
---

# Welcome to Pala

Build with code. Hand off with confidence.

<Info>
  Pala is a component-based CMS that streamlines the handoff between developers and content editors. Devs get full code control, clients get a foolproof editing experience.
</Info>
...
Write reusable blocks with Svelte and zero setup. Powerful in-browser IDE, instant responsive previews. Edit code, add fields, done.
  ...
  <Card title="Component Library" icon="layer-group">
    Build components once, reuse across all your sites. Browse the marketplace for starter sites and blocks.
  </Card>
  <Card title="Built-in Hosting" icon="server">
    Static site generation with hosting included. Deploy blazing-fast, secure, SEO-optimized sites with zero setup.
  </Card>
</CardGroup>
...
- Devs & techies building sites for friends and family
- Anyone tired of "the website broke 😩" texts

## Why Svelte?

Pala blocks are written in Svelte, a modern component framework. If you're new to Svelte, the [official tutorial](https://svelte.dev/tutorial) covers everything you need in under an hour.
