...
<Step title="Write your component">
  Use the in-browser editor to write your Svelte component code.
...
Design blocks to work in multiple contexts:

```svelte
// Good: Flexible and reusable
export let headline = "";
export let variant = "default"; // default, large, small

// Avoid: Too specific
export let homepage_headline = "";
```
